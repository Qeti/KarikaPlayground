 ...
 */
class AccountRESTController extends VoryxController
{
    const FORM = AccountType::class;
    ...
    /**
     * Partial Update to a Account entity.
     *
     * @ApiDoc
     * 
     * @View(serializerEnableMaxDepthChecks=true)
